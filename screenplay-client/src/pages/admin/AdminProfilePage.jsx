      ...
      <div className="max-w-2xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-text-secondary text-sm">
            Your admin account details and security settings.
          </p>
        </div>
        ...
        <div className="bg-bg-surface border border-white/[0.07] rounded-2xl overflow-hidden mb-6">
          {/* Accent banner */}
          <div className="relative h-24 bg-gradient-to-br from-accent/25 via-accent/8 to-purple-500/10">
            {/* decorative dots */}
            <div
              className="absolute inset-0 opacity-20"
              style={{
                backgroundImage:
                  "radial-gradient(circle, rgba(79,152,163,0.4) 1px, transparent 1px)",
            ...
            <div className="absolute bottom-0 left-6 translate-y-1/2">
              <div
                className="w-16 h-16 rounded-2xl border-4 border-bg-surface
                bg-accent/25 flex items-center justify-center relative"
              >
                ...
                <div
                  ...
                  bg-accent border-2 border-bg-surface flex items-center justify-center"
                >
          ...
          <div className="px-6 pt-12 pb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                ...
                >
                  <div
                    className="w-8 h-8 rounded-lg bg-accent/10 border border-accent/15
          ...
          <form onSubmit={handlePwChange} className="flex flex-col gap-4">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3.5 top-1/2 -translate-y-1/2
                    text-text-tertiary hover:text-white transition-colors"
                >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 py-3 rounded-xl
                ...
                hover:scale-[1.01] active:scale-95 mt-1"
            >
              {pwLoading ? (
                <>
